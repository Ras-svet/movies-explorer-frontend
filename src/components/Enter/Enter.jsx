...
function Enter (props) {
	return (
		<div className="enter">
			...
			<form className="enter__form" onSubmit={props.onClick}>
				{props.children}
				<button className={`enter__button ${props.login ? 'enter__button-login' : ''} ${props.isActive ? '' : 'enter__button_disable'}`} type="submit">{props.buttonTitle}</button>
			</form>
